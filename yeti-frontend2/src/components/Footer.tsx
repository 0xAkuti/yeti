...
export function Footer() {
  return (
    <footer className="border-t border-[#006e4e]/30 bg-black/40 backdrop-blur-sm mt-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-8 mb-6 md:mb-0">
            ...
            <p className="text-gray-400 text-sm text-center md:text-left max-w-md">
              Trade DeFi like a YETI. Automate your TradingView strategies with secure, decentralized limit orders.
            </p>
          </div>
